angular.module('pro').controller('points_testing', ['$scope', '$filter', function($scope, $filter) {
  ...
  $scope.users[1] = {name: 'Panko', signs: 15, scores: 2, gs_1s: 5, gs_2s: 4, gs_3s: 1, gs_4s: 3, efs: 12, qfs: 5, sfs: 2, fs: 1, cs: 0, tss: 0, points: 0};
  $scope.users[2] = {name: 'Vanko', signs: 8, scores: 12, gs_1s: 7, gs_2s: 4, gs_3s: 6, gs_4s: 3, efs: 14, qfs: 6, sfs: 2, fs: 0, cs: 0, tss: 1, points: 0}
  $scope.users[3] = {name: 'Ganko', signs: 10, scores: 3, gs_1s: 4, gs_2s: 5, gs_3s: 8, gs_4s: 3, efs: 10, qfs: 7, sfs: 1, fs: 1, cs: 1, tss: 0, points: 0}
  $scope.users[4] = {name: 'Danko', signs: 8, scores: 3, gs_1s: 4, gs_2s: 6, gs_3s: 9, gs_4s: 3, efs: 13, qfs: 6, sfs: 2, fs: 1, cs: 1, tss: 0, points: 0}
  $scope.users[5] = {name: 'Manko', signs: 15, scores: 3, gs_1s: 4, gs_2s: 2, gs_3s: 6, gs_4s: 3, efs: 14, qfs: 7, sfs: 1, fs: 0, cs: 0, tss: 0, points: 0}
  $scope.users[6] = {name: 'Zanko', signs: 20, scores: 4, gs_1s: 5, gs_2s: 2, gs_3s: 3, gs_4s: 3, efs: 11, qfs: 5, sfs: 2, fs: 2, cs: 1, tss: 0, points: 0}
